/**
 * This program prompts the user to enter 6 integers (separated by spaces) and displays
 * the integer values in 3 rows and 2 columns, with the 3rd column being a sum of each of
 * the numbers in the corresponding row.
 * 
 * @author Pranshu Suri
*/
